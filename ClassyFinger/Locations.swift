...
class ARobject: NSObject{
    ...
    init(laditude: Double, longitude: Double, node: SCNNode, altitude: Double, name: String) {
        self.laditude = laditude
        self.longitude = longitude
        self.altitude = altitude
        self.label = name
...
class Locations: NSObject{
   ...
   // var test = [ARobject(laditude: 312.3, longitude: 32.3, node: , altitude: <#T##Double#>, name: <#T##String#>)]
